...
class NeteaseCrypto {
  ...
  static const String _pubKey = '010001'; // RSA public key exponent (hex)
  ...
  static Map<String, String> encryptRequest(Map<String, dynamic> params) {
    ...
    return {
      'params': _aesEncrypt(
        _aesEncrypt(text, _presetKey, secret),
        secret,
        '0102030405060708',
      ),
  ...
  static Map<String, String> encryptEapi(
    String url,
  ...
  static String _rsaEncrypt(String text) {
    final reversedBytes = Uint8List.fromList(
      utf8.encode(text).reversed.toList(),
    );
